    ...
    <>
      ...
      {toggle && (
        <div
          ...
          } bg-opacity-90 shadow-2xl shadow-black p-8 overflow-y-scroll scrollbar  scrollbar-track-transparent fixed w-[90%] h-[80%] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50`}
        >
          <button
...
export const AboutWindow = () => {
  ...
  return (
    <>
      <button
        className={`pitch-btn my-2 -skew-x-12 ${
          selectedTheme === "Tranquil"
            ? " bg-water-100 text-fairy-300"
            : " bg-superDry-accent text-superDry-primary rounded-none"
        }`}
        ...
        <div
          className={`${
            selectedTheme === "Tranquil"
              ? " bg-earth-100 text-water-100 rounded-l-xl scrollbar-thumb-water-400"
              : " bg-superDry-accent text-superDry-primary scrollbar-thumb-superDry-accent2"
          } bg-opacity-90 shadow-2xl shadow-black p-8 overflow-y-scroll scrollbar  scrollbar-track-transparent fixed w-[90%] h-[80%] sm:h-fit top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50`}
        >
          <button
            className="absolute top-4 right-8 bg-transparent p-0"
            onClick={() => setToggle(!toggle)}
