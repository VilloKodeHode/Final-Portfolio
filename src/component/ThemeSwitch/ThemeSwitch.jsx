...
import THEMESWITCH from "./assets/Icon-themeswitch.png";
    ...
    <div className="absolute top-0 right-16 z-40 w-20 -skew-x-[20deg]">
      <div className="absolute top-1 left-2 h-8 ">
        {selectedTheme === "Tranquil" ? (
          <svg
            className="swap-on  w-10 h-10 fill-superDry-accent bg-fairy-300"
          ...
          <svg
            className="swap-off w-10 h-10 fill-water-100 bg-superDry-accent"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
